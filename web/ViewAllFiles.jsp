                   ...
                   String filename=r.getString("fname");
                    ...
                    <table>
                        <tr><th>File Name</th><td><%=filename%></td></tr>
                         <tr><th>File Data</th><td><textarea cols="30" rows="15"><%=skey1%></textarea></td></tr>
                         <tr><th>Block1</th><td><textarea cols="30" rows="15"><%=skey1%></textarea></td></tr>
                        
<tr><th>Block2</th><td><textarea cols="30" rows="15"><%=skey2%></textarea></td></tr>
