...
<div class="wrapper col5">
 ...
 if(operation.equals("write")){
     ...
     <form action="UpdateDataAction.jsp?operation=<%=operation%>" method="post">
          <table>
                      <tr><th>Write data to be update</th><td>
                              <textarea cols="30" rows="15" name="data"></textarea> </td>
                      <tr>
...
response.sendRedirect("UpdateDataAction.jsp?operation="+operation);
}
          %>
